...
?>
	<p class="input input--cortex"><input type="text" name="<?php echo $this->id_base . '_first_name'; ?>" class="input__field input__field--cortex" /><label class="input__label input__label--cortex input__label--cortex-color-1"><span class="input__label-content--cortex"><?php echo __('First', 'mailchimp-widget'); ?></span></label></p>
<?php
	}
	if ($instance['collect_last']) {
?>
	<p class="input input--cortex"><input type="text" name="<?php echo $this->id_base . '_last_name'; ?>" class="input__field input__field--cortex" /><label class="input__label input__label--cortex input__label--cortex-color-1"><span class="input__label-content--cortex"><?php echo __('Last', 'mailchimp-widget'); ?></span></label></p>
<?php
	}
?>
	<br>
