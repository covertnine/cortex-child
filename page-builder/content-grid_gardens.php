    ...
    ?>
			<div class="row wow animated fadeInUp">
				<div class="magazine_latest_title col-md-12 mar30B">
					<?php if ($cortex_title != '') {
        echo '<span class="h1 center mar10B">' . $cortex_title . '</span>';
    } ?>
                                    ...
                                    if ($cortex_format != 'quote') {
										...
										<div class="magazine-article-header">
											...
											// Use the Friendly Heading if there is one -- Sam
												if ( get_field('friendly_heading') ) {
													$entry_title = get_field('friendly_heading');
												} else {
													$entry_title = get_the_title();
													} 
											?>

											<a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php echo $entry_title ?></a>

											</h5>
											<?php
											//if there is a subheading, add it here 
											if ( get_field('subheading') ) { 
												echo "<p class='garden-grid-subheading'>" . get_field('subheading') . "</p>";
											} 
											?>
...
<?php $cortex_counter++;
unset($cortex_title, $cortex_sub_title, $cortex_filter_by_category, $cortex_filter_by_region, $cortex_number_of_posts, $cortex_view_more_btn, $cortex_view_more_button_link, $cortex_customClass, $cortex_display_date, $cortex_display_post_meta, $cortex_display_post_excerpt, $cortex_number_of_posts_to_display); ?>
