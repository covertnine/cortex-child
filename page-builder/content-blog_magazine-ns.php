...
<section id="section-<?php echo $cortex_counter; ?>" class="magazine_latest<?php if ( ! empty( $cortex_customClass ) ) { echo ' '.$cortex_customClass; } ?>">
	<div class="section-bg">
			...
			<div class="row wow animated fadeInUp">
				<div class="magazine_latest_title col-md-12 mar30B" data-top="opacity: 1" data-top-bottom="opacity: 0" data-anchor-target="#section-<?php echo $cortex_counter; ?> .magazine_latest_title">
					<?php if ( $cortex_title != '' ) { echo '<span class="h1 center mar10B bg-container-sm">' . $cortex_title . '</span>';} ?>
					<?php if ( $cortex_sub_title != '' ) { echo '<span class="subtitle center mar10B bg-container-sm">' . $cortex_sub_title . '</span>';} ?>
				</div>
			</div>
			<?php } ?>
...
?>
				...
				<div class="col-md-12 magazine_latest_content" id="magazine-latest-<?php echo $cortex_counter; ?>" data-center-bottom="opacity: 1" data-top-bottom="opacity: 0" data-anchor-target="#section-<?php echo $cortex_counter; ?> .magazine_latest_content">
							...
							<article class="magazine-article mar50B wow animated fadeInUp <?php echo $cortex_format; ?>">
								...
								?>
										...
										case 'quote':
											...
											if ( has_post_thumbnail() ) {
								?>
								<div class="dark-overlay"><a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php the_post_thumbnail( 'cortex-featured-wide', array( 'class' => 'img-responsive' ) ); ?></a><span class="h6 quote-source"><strong><?php echo $cortex_person; ?></strong></span></div>
			<?php
											}
								?>
