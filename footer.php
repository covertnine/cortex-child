...
<?php include( get_template_directory() . '/inc/site-social.php' ); ?>
<?php include( get_template_directory() . '/inc/site-search.php' ); ?>
<?php wp_footer(); ?>
...
<?php
	if ($cortex_welcome_window == 'enable') {
		echo '<a href="/welcome-window-5/" class="welcome-window"></a>';
	}
?>
</body>
</html>
