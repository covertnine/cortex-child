<?php
    ...
    $args = array(
        ...
        'dev_mode' => false,
        'use_cdn' => FALSE,
        'display_name' => 'Cortex Options',
        'display_version' => '1.2',
        'page_slug' => 'cortex-options',
        'page_title' => 'Cortex Options',
        'update_notice' => FALSE,
        'intro_text' => 'Options to customize the Cortex WordPress theme. For more documentation refer to the online documentation located at cortex.covertnine.com/documentation',
        'footer_text' => '',
        'admin_bar' => TRUE,
        'menu_type' => 'menu',
        'menu_title' => 'Cortex Options',
        'allow_sub_menu' => TRUE,
        ...
        'fields'     => array(
            ...
            array(
                ...
                'options'  => array(
	                'sidebar-left' => array(
	                	'alt'		=>		'Left',
	                	'img'		=>		'//www.covertnine.com/wp-content/uploads/2017/06/sidebar-left.png',
	                ),
	                'sidebar-right' => array(
	                	'alt'		=>		'Right',
	                	'img'		=>		'//www.covertnine.com/wp-content/uploads/2017/06/sidebar-right.png',
	                ),
	                'sidebar-none' => array(
	                	'alt'		=>		'No sidebar',
	                	'img'		=>		'//www.covertnine.com/wp-content/uploads/2017/06/sidebar-none.png',
	                )
                ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
            array(
                ...
                'default'  => array(
	                'url'		=> get_bloginfo('template_directory') . '/img/cortex@2x.png'
                ),
            ),
            array(
                'id'       => 'c9-touch-icon',
            ...
            array(
                ...
                'required'	=> array('c9-enable-preloader', '=', true),
                'default'  => array(
	                'url'		=> get_bloginfo('template_directory') . '/img/ajax-loader.gif'
                ),
            ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
            ...
            array(
                ...
                'subtitle' => __( 'Headline colors, widget headings, meta links under posts', 'cortex' ),
                'default'  => '',
            ),
            array(
                'id'       => 'c9-second-color',
            ...
            array(
	            ...
	            'options'			=> array(
					'logo-left' 	=> array(
						...
						'img'		=> '//www.covertnine.com/wp-content/uploads/2017/06/logo-left.png',
					),
					'logo-right'	=> array(
						'alt'		=> __('Logo Right', 'cortex'),
						'img'		=> '//www.covertnine.com/wp-content/uploads/2017/06/logo-right.png',
					),
					'logo-center'	=> array(
						'alt'		=> __('Logo Center', 'cortex'),
						'img'		=> '//www.covertnine.com/wp-content/uploads/2017/06/logo-center.png',
					)
				),
				'default'			=> 'logo-left'
			), //end single field
            ...
            array(
	            ...
	            'options'			=> array(
					'layout1' 	=> array(
						...
						'img'		=> 'https://gallery.mailchimp.com/136895fb25511307a983ed582/images/7f09d295-4f48-4b33-9c12-38d2cc5e2ad1.png',
					),
					'layout2'	=> array(
						'alt'		=> __('Footer Layout 2', 'cortex'),
						'img'		=> 'https://gallery.mailchimp.com/136895fb25511307a983ed582/images/649446fc-e4a3-4478-b227-dbc874d29bee.png',
					),
					'layout3'	=> array(
						'alt'		=> __('Footer Layout 3', 'cortex'),
						'img'		=> 'https://gallery.mailchimp.com/136895fb25511307a983ed582/images/c1ff51ba-ca85-4d1f-b321-8ac196d859cb.png',
					)
				),
	            'default'	=> 'layout1',
            ),
            ...
            array(
	            ...
	            'options'	=> array(
		            'upper-left' => array(
							...
							'img'	=> '//www.covertnine.com/wp-content/uploads/2017/06/social-upper-left.png'
							),
					'upper-right' => array(
							'alt'	=> __('Upper Right', 'cortex'),
							'img'	=> '//www.covertnine.com/wp-content/uploads/2017/06/social-upper-right.png'
							),
					'lower-left' => array(
							'alt'	=> __('Lower Left', 'cortex'),
							'img'	=> '//www.covertnine.com/wp-content/uploads/2017/06/social-lower-left.png'
							),
					'lower-right' => array(
							'alt'	=> __('Lower Right', 'cortex'),
							'img'	=> '//www.covertnine.com/wp-content/uploads/2017/06/social-lower-right.png'
							),
	            ),
	            'required'	=> array('c9-enable-social', 'equals', true),
	            'default'	=> 'lower-left'
