		    	...
		    	<div class="nav-contain"<?php cortex_navigation_padding(); ?>>
	                ...
	                <div class="container">
		    	        ...
		    	        <div class="logo-header">
		                    ...
		                    if ( ! empty( $cortex_theme_options['c9-logo']['url'] ) ) { //logo has been uploaded
								$cortex_logo_image = $cortex_protocol. str_replace(array('http:', 'https:'), '', $cortex_theme_options['c9-logo']['url']);
		                    ?>

		                    <a class="header-image" href="<?php echo $home_url; ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home" id="logo"><img src="<?php echo esc_url( $cortex_logo_image ); ?>" alt="<?php esc_attr( bloginfo( 'name' ) ); ?>" <?php if ( $cortex_theme_options['c9-navigation-layout'] != 'logo-center' ) { ?> data-start="height: 90px; padding-top: 0px;" data-90-start="height: 50px; padding-top: 5px;" <?php } else {?> data-start="height: 50px;" data-90-start="height: 35px;" <?php } ?>></a>
