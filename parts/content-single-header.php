...
if ( ($cortex_enable_big_header == 'enable') || ($cortex_enable_big_header == '') || ($cortex_enable_big_header == 'default') || ($cortex_enable_big_header == '1') ) { //see if big header is enabled, if not skip it all
...
} //big header is disabled, so don't show that bigass thing ?>
