			...
			<div class="entry-header-standard">
				<div class="entry-header-standard-inner" data-100-top="opacity: 1" data-top-bottom="opacity: 0" data-anchor-target=".entry-header-standard-inner .container">
					<div class="container">
						...
						<?php if (!empty($c9_post_sub_heading)) { ?><span class="riot_subheading h5 subheading light<?php if ( ! empty( $cortex_color_switch ) ) { echo $cortex_color_switch;} ?>"><?php echo $c9_post_sub_heading; ?></span><?php } ?>
